...
public class Or extends Activity {
    ...
    public static final Order ORDER_THE = new Order("the", "Runs the logic OR between the [caseA] or the [caseB].", PARAM_THE_CASE_A, PARAM_THE_CASE_B);

    public Or(Context context) {
        super(context, "Returns the logical OR between the passed by.");
    }
